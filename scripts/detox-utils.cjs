  ...
  return {
    ...
    apps: {
      ...
      'tvos.debug': {
        ...
        build:
          `xcodebuild -workspace ios/${applicationName}.xcworkspace -UseNewBuildSystem=YES -scheme ${applicationName} -configuration Debug -sdk appletvsimulator -derivedDataPath ios/build -quiet | xcpretty`,
      },
    },
    devices: {
      simulator: {
